...
defmodule PostgresListener.Postgres.Decoder do
  ...
  alias PostgresListener.Postgres.OidDatabase
  ...
  ## Examples
      ...
      %PostgresListener.Postgres.Decoder.Messages.Insert{relation_id: 24576, tuple_data: {"baz", "560"}}
